...
<aside class="col-xs-offset-1 col-xs-10 col-md-2 sidebar">
    ...
    <section class="partners">
        ...
        <a href="http://courtauld.ac.uk/"><img src="<?php echo get_template_directory_uri();?>/assets/img/courtauld-logo-primary.png" alt="The Courtauld Institute of Art"/></a>
        <a href="http://www.arts.ac.uk/"><img src="<?php echo get_stylesheet_directory_uri();?>/assets/img/ual-logo.jpg" alt="University of the Arts"/></a>
    </section>
